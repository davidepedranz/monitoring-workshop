...
def test_get_list_with_multiple_todos(repository: Repository) -> None:
    ...
    todos = repository.list()
    assert todos == tuple(sorted((Todo(id=id_1, text=text_1, active=True), Todo(id=id_2, text=text_2, active=True))))
...
def test_edit_text_existing_todo(repository: Repository) -> None:
    ...
    todos = repository.list()
    assert todos == tuple(sorted((Todo(id=id_1, text=text_1, active=True), Todo(id=id_2, text="Hello", active=True))))
...
def test_mark_complete_existing_todo(repository: Repository) -> None:
    ...
    todos = repository.list()
    assert todos == tuple(sorted((Todo(id=id_1, text=text_1, active=True), Todo(id=id_2, text=text_2, active=False))))
